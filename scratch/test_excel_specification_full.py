...
EXCEL_PATH = r"C:\Users\Hp\Downloads\Control_Source_Logic.xlsx"
...
class TestExcelSpecificationFull(unittest.TestCase):
    ...
    def test_01_direct_excel_parsing(self):
        ...
        self.assertEqual(ctrl.get("control_number"), "CTRL-TEST")
        self.assertIn("Control-Test", ctrl.get("control_title"))
        ...
        self.assertEqual(schema_name, "ra_ctrl.ctrl_test")
        ...
        self.assertIn("CTRL_TEST_SOURCE_DATASET_DDOS", dm_names)
        self.assertIn("CTRL_TEST_SOURCE_DATASET_VDOM", dm_names)
        self.assertIn("ETL_DATA_ACQUISITION", dm_names)
        self.assertIn("CTRL_TEST_FILTERED_DATASET_DDOS", dm_names)
        self.assertIn("CTRL_TEST_FILTER_SUMMARY", dm_names)
        self.assertIn("CTRL_TEST_BALANCE_DATASET_VDOM", dm_names)
        self.assertIn("CTRL_TEST_WORKING_DATASET_RL", dm_names)
        self.assertIn("CTRL_TEST_WORKING_DATASET_KL", dm_names)
        self.assertIn("CTRL_TEST_WORK_ITEM_CURRENT_RUN", dm_names)
    ...
    def test_04_api_upload_and_auto_analysis(self):
        ...
        with open(EXCEL_PATH, "rb") as f:
            u_resp = self.session.post(
                ...
                files={"file": ("Control_Source_Logic.xlsx", f, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")}
            )
        ...
        self.assertEqual(analysis["control_overview"]["identification"]["control_number"], "CTRL-TEST")
    ...
    def test_05_target_logic_builder_and_gated_deployment(self):
        ...
        3. Target DDL builds with target schema 'ra_ctrl.ctrl_test'.
        """
