...
def test_format_enforcement():
    ...
    # Test 3: Upload actual Control_Source_Logic.xlsx
    xlsx_path = r"C:\Users\Hp\Downloads\Control_Source_Logic.xlsx"
    assert os.path.exists(xlsx_path), f"File not found: {xlsx_path}"
    with open(xlsx_path, "rb") as f:
        res_xlsx = s.post(f"{BASE}/api/projects/22/upload", files={"file": ("Control_Source_Logic.xlsx", f, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")}, headers=headers)
